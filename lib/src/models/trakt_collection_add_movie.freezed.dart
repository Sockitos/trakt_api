...
part of 'trakt_collection_add_movie.dart';
...
TraktCollectionAddMovie _$TraktCollectionAddMovieFromJson(
    Map<String, dynamic> json) {
  return _TraktCollectionAddMovie.fromJson(json);
}

/// @nodoc
mixin _$TraktCollectionAddMovie {
  ...
  @JsonKey(ignore: true)
  $TraktCollectionAddMovieCopyWith<TraktCollectionAddMovie> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TraktCollectionAddMovieCopyWith<$Res> {
  factory $TraktCollectionAddMovieCopyWith(TraktCollectionAddMovie value,
          $Res Function(TraktCollectionAddMovie) then) =
      _$TraktCollectionAddMovieCopyWithImpl<$Res, TraktCollectionAddMovie>;
  @useResult
  $Res call(
...
/// @nodoc
class _$TraktCollectionAddMovieCopyWithImpl<$Res,
        $Val extends TraktCollectionAddMovie>
    implements $TraktCollectionAddMovieCopyWith<$Res> {
  _$TraktCollectionAddMovieCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_TraktCollectionAddMovieCopyWith<$Res>
    implements $TraktCollectionAddMovieCopyWith<$Res> {
  factory _$$_TraktCollectionAddMovieCopyWith(_$_TraktCollectionAddMovie value,
          $Res Function(_$_TraktCollectionAddMovie) then) =
      __$$_TraktCollectionAddMovieCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DateTime? collectedAt,
...
/// @nodoc
class __$$_TraktCollectionAddMovieCopyWithImpl<$Res>
    extends _$TraktCollectionAddMovieCopyWithImpl<$Res,
        _$_TraktCollectionAddMovie>
    implements _$$_TraktCollectionAddMovieCopyWith<$Res> {
  __$$_TraktCollectionAddMovieCopyWithImpl(_$_TraktCollectionAddMovie _value,
      $Res Function(_$_TraktCollectionAddMovie) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_TraktCollectionAddMovie(
      collectedAt: freezed == collectedAt
          ? _value.collectedAt
          : collectedAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
...
/// @nodoc
@JsonSerializable()
class _$_TraktCollectionAddMovie implements _TraktCollectionAddMovie {
  const _$_TraktCollectionAddMovie(
      {this.collectedAt,
      @JsonKey(includeFromJson: false, includeToJson: false)
  ...
  factory _$_TraktCollectionAddMovie.fromJson(Map<String, dynamic> json) =>
      _$$_TraktCollectionAddMovieFromJson(json);
  ...
  @override
  String toString() {
    return 'TraktCollectionAddMovie(collectedAt: $collectedAt, collectedAtRelease: $collectedAtRelease, ids: $ids, resolution: $resolution, hdr: $hdr, audio: $audio, audioChannels: $audioChannels, is3D: $is3D)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_TraktCollectionAddMovie &&
  ...
  int get hashCode => Object.hash(runtimeType, collectedAt, collectedAtRelease,
      ids, resolution, hdr, audio, audioChannels, is3D);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_TraktCollectionAddMovieCopyWith<_$_TraktCollectionAddMovie>
      get copyWith =>
          __$$_TraktCollectionAddMovieCopyWithImpl<_$_TraktCollectionAddMovie>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TraktCollectionAddMovieToJson(
      this,
    );
  }
}

abstract class _TraktCollectionAddMovie implements TraktCollectionAddMovie {
  const factory _TraktCollectionAddMovie(
      {final DateTime? collectedAt,
      @JsonKey(includeFromJson: false, includeToJson: false)
      final bool collectedAtRelease,
      ...
      final TraktAudioMetadata? audio,
      final TraktAudioChannelsMetadata? audioChannels,
      @JsonKey(name: '3d') final bool? is3D}) = _$_TraktCollectionAddMovie;

  factory _TraktCollectionAddMovie.fromJson(Map<String, dynamic> json) =
      _$_TraktCollectionAddMovie.fromJson;
